...
class DatabaseFactory(
    ...
    fun build(): Database = Database(
        ...
        device_dataAdapter = Device_data.Adapter(
            ...
            pv_t3Adapter = FloatColumnAdapter,
            pv_rhAdapter = FloatColumnAdapter,
            pv_co2_1Adapter = IntColumnAdapter,
            pv_co2_2Adapter = IntColumnAdapter,
            pv_co2_3Adapter = IntColumnAdapter,
            pv_timerAdapter = IntColumnAdapter,
            pv_tmr_countAdapter = IntColumnAdapter,
            ...
            cost0Adapter = IntColumnAdapter,
            cost1Adapter = IntColumnAdapter,
            dateAdapter = IntColumnAdapter,
            hoursAdapter = IntColumnAdapter
        ),
    )
}
