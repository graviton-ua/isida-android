...
val WhIcons.Theme.Award: ImageVector
    get() {
        if (_award != null) return _award!!
        _award = materialIcon(name = "Theme.Award") {
            materialPath {
...
@Preview
@Composable
private fun Preview() = Icon(imageVector = WhIcons.Theme.Award, contentDescription = null)