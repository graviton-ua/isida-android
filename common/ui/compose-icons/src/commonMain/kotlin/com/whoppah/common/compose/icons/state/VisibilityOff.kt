...
val WhIcons.State.VisibilityOff: ImageVector
    get() {
        if (_visibilityOff != null) return _visibilityOff!!
        _visibilityOff = materialIcon(name = "State.VisibilityOff") {
            materialPath {
                moveTo(12.0F, 7.0F)
...
@Preview
@Composable
private fun Preview() = Icon(imageVector = WhIcons.State.VisibilityOff, contentDescription = null)