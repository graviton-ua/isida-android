...
val WhIcons.State.StarHalf: ImageVector
    get() {
        if (_starHalf != null) return _starHalf!!
        _starHalf = materialIcon(name = "State.StarHalf") {
            materialPath {
                moveTo(22.0F, 9.24F)
...
@Preview
@Composable
private fun Preview() = Icon(imageVector = WhIcons.State.StarHalf, contentDescription = null)