package ua.isida.common.ui.compose.toaster
...
import ua.isida.common.ui.compose.toaster.Toaster.Duration
import ua.isida.common.ui.compose.toaster.Toaster.ToastType
...
fun AppToasterHost(
    ...
    val containerColor = when (visuals?.type) {
        ToastType.SUCCESS -> IsidaTheme.colors.toastSuccessContainer
        ToastType.ERROR -> IsidaTheme.colors.toastErrorContainer
        else -> IsidaTheme.colors.toastContainer
    }

    val contentColor = when (visuals?.type) {
        ToastType.SUCCESS -> IsidaTheme.colors.toastSuccessContent
        ToastType.ERROR -> IsidaTheme.colors.toastErrorContent
        else -> IsidaTheme.colors.toastContent
    }

    val actionColor = when (visuals?.type) {
        ToastType.SUCCESS -> IsidaTheme.colors.toastSuccessAction
        ToastType.ERROR -> IsidaTheme.colors.toastErrorAction
        else -> IsidaTheme.colors.toastAction
    }
