...
@Composable
fun rememberWhoppahTypography(): WhoppahTypography {
    ...
    return remember {
        WhoppahTypography(filsonPro = FontFamily.Default, notoSans = FontFamily.SansSerif)
    }
}

@Immutable
class WhoppahTypography(
    ...
    fun textLink(color: Color = WhoppahTheme.colors.link): TextLinkStyles {
