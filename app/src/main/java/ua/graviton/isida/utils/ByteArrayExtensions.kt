...
fun Short.asByteArray(order: ByteOrder = ByteOrder.LITTLE_ENDIAN): ByteArray = ByteBuffer.allocate(Short.SIZE_BYTES).order(order).putShort(this).array()
fun Int.asByteArray(order: ByteOrder = ByteOrder.LITTLE_ENDIAN): ByteArray = ByteBuffer.allocate(Int.SIZE_BYTES).order(order).putInt(this).array()
fun Long.asByteArray(order: ByteOrder = ByteOrder.LITTLE_ENDIAN): ByteArray = ByteBuffer.allocate(Long.SIZE_BYTES).order(order).putLong(this).array()
fun Float.asByteArray(order: ByteOrder = ByteOrder.LITTLE_ENDIAN): ByteArray = ByteBuffer.allocate(Float.SIZE_BYTES).order(order).putFloat(this).array()
fun Double.asByteArray(order: ByteOrder = ByteOrder.LITTLE_ENDIAN): ByteArray =
