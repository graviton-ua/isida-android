...
object IsidaCommands {
    ...
    fun updateProperties(
        ...
        val extOff1 = (props.findIsInstance<DeviceProperty.ExtOff1>()?.value ?: deviceDataSnapshot.extOff1).toByte()
        ...
        val forceHeat = (props.findIsInstance<DeviceProperty.ForceHeat>()?.value ?: deviceDataSnapshot.forceHeat).toByte()
