...
sealed class DeviceProperty<T>(
    ...
    data class SpT0(override val value: Float) : DeviceProperty<Float>(
        value = value,
        info = DeviceCharacteristicInfo.SpT0,
    )

    data class SpT1(override val value: Float) : DeviceProperty<Float>(
        value = value,
        info = DeviceCharacteristicInfo.SpT1,
    )

    data class SpRh0(override val value: Float) : DeviceProperty<Float>(
        value = value,
        info = DeviceCharacteristicInfo.SpRh0,
    )

    data class SpRh1(override val value: Float) : DeviceProperty<Float>(
        value = value,
        info = DeviceCharacteristicInfo.SpRh1,
    )

    data class K0(override val value: Int) : DeviceProperty<Int>(
        value = value,
        info = DeviceCharacteristicInfo.K0,
    )

    data class K1(override val value: Int) : DeviceProperty<Int>(
        value = value,
