...
sealed class DeviceProperty<T>(
    ...
    data class Alarm0(private val _value: Int) : DeviceProperty<Int>(id = "alarm0", value = _value, info = DeviceCharacteristicInfo.K1)
    data class Alarm1(private val _value: Int) : DeviceProperty<Int>(id = "alarm1", value = _value, info = DeviceCharacteristicInfo.K1)
